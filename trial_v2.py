...
class Converter:
    ...
    def __init__(self):
        ...
        self.storage_heading.grid(row=0, columnspan=3)
        ...
        self.storage_instructions = Label(self.storage_frame,
                                          ...
                                          wrap=250, width=40,
                                          justify="left")
        self.storage_instructions.grid(row=1, columnspan=3)
        ...
        self.output_label = Label(self.storage_frame, text="",
                                  fg="#9C0000")
        self.output_label.grid(row=5, columnspan=3)
        ...
        self.convert_button.grid(row=6, columnspan=3, padx=5, pady=5)
