...
class DonationPopup:
    ...
    def __init__(self, parent):
        self.donation_popup = Toplevel(parent)
        self.donation_popup.title("Thank You for Your Donation")

        Label(self.donation_popup, text="Thank you for your donation!", font=("Arial", 12)).pack(padx=20, pady=20)
...
class Converter:
    ...
    # Shows the donation popup
    def show_donation_popup(self):
        DonationPopup(self.storage_frame)
